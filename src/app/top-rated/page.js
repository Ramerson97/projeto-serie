...
const TopRated = () => {
  ...
  useEffect(() => {
    const fetchSeries = async () => {
      try {
        const response = await axios.get('https://api.themoviedb.org/3/tv/top_rated?language=pt-BR&api_key=b7efa4ca3226bcb649d9662e3d18e4fe');
          ...
          <Col key={serie.id} md={4}>
            <Card style={{ marginBottom: '20px' }}>
              ...
              <Card.Body>
                ...
                <Link href={`/serie/${serie.id}`} passHref> {/* Correção aqui */}
